...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStompClient = Stomp.over(Stomp.ConnectionProvider.OKHTTP, "ws://" + ANDROID_EMULATOR_LOCALHOST
                + ":" + RestClient.SERVER_PORT + "/stomp/websocket");
//        mStompClient = Stomp.over(Stomp.ConnectionProvider.OKHTTP, "ws://fuelware-env.mkp8vm63pa.ap-south-1.elasticbeanstalk.com:6614/stomp");
    ...
    public static final String PASSCODE = "admin";
